...
Classify the user request into ONE agent: coding, search, pdf, ppt, image, vision, pdf_rag, data_analysis, agents_team, chat.
...
def fast_heuristic_router(prompt: str) -> str:
    ...
    if any(k in p for k in ["generate doc", "generate document", "create report pdf", "build pdf", "create a pdf"]):
        return "pdf"
